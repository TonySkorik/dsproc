...
namespace UniDsproc.DataModel
{
	...
	public class ErrorInfo : PrintableInfo
	{
		...
		public ErrorInfo(string errorCode, ErrorType errorType, string msg)
		{
			...
			string[] msgParts =
				(msg.Split('\r')[0])
				.Split(']'); // because error message from exception contains unwanted string seperated by \r\n
			...
			{
				Message = msg.Split(
					'\r')[0]; // because error message from exception contains unwanted string seperated by \r\n
			}
